    ...
    <div className='bg-[#141414] py-10'>
      <div className="px-[4%] mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-5 text-[#B3B3B3]">
          <div>
            <div className="text-base md:text-base lg:text-[1.25rem] lg:leading-[1.75rem] mb-2.5 ">ABOUT US</div>
            <p className='text-base md:text-base lg:text-[1rem] lg:leading-[1.75rem] mb-2.5'>At Elite Group Holding, we are committed to enhance the quality of life within the communities we serve, continuously seek avenues for fostering growth and make a positive impact on the world and our community. </p>
            <p className='text-base md:text-base lg:text-[1rem] lg:leading-[1.75rem] mb-2.5'>Headquartered in the United Arab Emirates, our expansive portfolio encompasses automotive, e-commerce, healthcare, real estate and contracting, and investments.</p>
            <p className='text-base md:text-base lg:text-[1rem] lg:leading-[1.75rem] mb-2.5'>We pride ourselves on our unwavering dedication to excellence, integrity, and teamwork.</p>
          </div>

          <div className='flex gap-2 md:justify-around justify-between'>
            <div>
              <div className='md:text-base lg:text-[1.25rem] lg:leading-[1.75rem] mb-4'>NAVIGATION</div>
            ...
            <div>
              <div className='md:text-base lg:text-[1.25rem] lg:leading-[1.75rem] mb-4'>GROUP OF COMPANIES</div>
              <div className="grid gap-2 text-base md:text-base lg:text-[1rem] lg:leading-[1.75rem]">
          ...
          <div>
            <div className='md:text-base lg:text-[1.25rem] lg:leading-[1.75rem] mb-4'>SUBSCRIBE</div>
