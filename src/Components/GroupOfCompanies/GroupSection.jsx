...
const GroupSection = ({ image, title, descriptions, url = '#', hasBrands = false }) => {
    return (
        <>
            <div className="overflow-hidden max-md:px-[3%]">
                <div className="flex max-md:flex-col-reverse max-md:gap-3 md:flex-row sm:items-center max-md:my-10">
                    ...
                    <div className="md:px-12 lg:px-20 xl:px-24 sm:shrink-1 sm:w-1/2">
                        ...
                        <a href={url} className="bg-black hover:bg-[#fb511e] text-white transition-all border border-1 border-black hover:border-[#fb511e] rounded-full px-10 py-3 button-1 font-light mb-2 md:mb-8">
                            Read More
