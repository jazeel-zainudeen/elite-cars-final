...
const AboutUs = () => (
    <>
        ...
        <div className="bg-[#F7F7F7]">
            ...
            <div className="px-[3%]">
                <div className="my-5 md:my-10 flex max-md:flex-col-reverse max-md:gap-3 sm:flex-row-reverse sm:items-center">
                    ...
                    <div className="xl:px-24 sm:shrink-1 sm:w-1/2">
                        <div className="text-md sm:text-base lg:text-xl font-medium mb-2 md:mb-4">OUR HISTORY</div>
                        <p className="font-semibold mb-2 md:mb-4 text-[#404040] text-xl md:text-xl">It all started with a dream</p>
            ...
            <div className="px-[3%] sm:-mt-16 md:-mt-20 lg:-mt-24 xl:-mt-26">
                <div className="my-5 md:my-10 sm:flex sm:flex-row-reverse sm:items-center">
                    <div className="xl:px-24 sm:shrink-1 sm:w-1/2 xl:pt-10">
                        <div className="text-md sm:text-base lg:text-xl font-medium mb-2 md:mb-4">VISION AND MISSION</div>
                        <p className="mb-2 md:mb-4 text-[#404040] text-xs md:text-sm">
                            Elite Group Holding Ltd, is more than just a group holding company. We are visionaries, innovators and creators of tomorrow’s possibilities.
                        </p>
                    ...
                    <div className="relative sm:w-1/2 sm:grow sm:shrink-0 sm:-ms-[3.5%] max-md:mt-3 overflow-hidden">
        ...
        <div className="container mx-auto my-10 px-0 md:px-[3%]">
            <div className="font-extrabold text-5xl uppercase sm:ps-0 ps-[3%]">Meet the team</div>
        </div>
        ...
        <div className="container mx-auto md:py-24 py-16 px-[3%]">
            <div className="font-medium text-xl mb-5">ORGANIZATION STRUCTURE</div>
        ...
        <div className="relative w-screen h-[75vh]">
            ...
            <div className="absolute top-1/2 left-0 px-[3%] -translate-y-1/2 z-10 text-white">
                ...
                <div className="text-md md:text-lg font-medium md:w-1/2 text-[#B3B3B3]">Enriching Communities program was launched in 2018, to affirm the Group’s commitment to CSR and helping local and international communities. CSR is embedded in the organization’s culture, as we continue to launch initiatives to support the UAE leadership’s vision and contribute to the economic development while improving the quality of life of our society, customers, partners, and employees.</div>
            </div>
        </div>
